...
export declare class LanguageFrench extends LanguageImpl {
    ...
    getConjugation(subject: any, verb: SomeTense, originalTense: string, number: Numbers, conjParams: ConjParamsFr, genderNumberManager: GenderNumberManager, embeddedVerbs: VerbsData): string;
