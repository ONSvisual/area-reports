...
function getRosaeNlgVersion() {
    return '3.2.2'; // will be replaced by gulp when copied into dist/
}
...
class NlgLib {
    constructor(params) {
        ...
        this.helper = new Helper_1.Helper(this.genderNumberManager, this.saveRollbackManager, params.renderDebug);
        ...
        this.verbsManager = new VerbsManager_1.VerbsManager(this.languageImpl, this.genderNumberManager, this.synManager, this.saveRollbackManager);
