...
export declare class LanguageEnglish extends LanguageImpl {
    ...
    getConjugation(_subject: any, verb: string, tense: SomeTense, number: Numbers, conjParams: ConjParamsEn, _genderNumberManager: GenderNumberManager, embeddedVerbs: VerbsData): string;
