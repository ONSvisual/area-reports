import { c as create_ssr_component, e as escape, d as each, b as add_attribute, s as setContext, v as validate_component, g as getContext, n as null_to_empty, h as createEventDispatcher, m as missing_component, i as spread, j as escape_object, k as escape_attribute_value, l as globals, o as noop, p as safe_not_equal, f as subscribe, r as run_all, q as is_function, t as set_store_value, a as add_styles, u as assign, w as now, x as loop, y as identity$1 } from "../../chunks/index-6a0f4aab.js";
import "archieml";
...
<div class="${[
    ...
    ${Icon ? `${validate_component(Icon || missing_component, "svelte:component").$$render($$result, Object_1$1.assign(iconProps), {}, {})}` : ``}
    ...
    ${listOpen ? `${validate_component(List$1 || missing_component, "svelte:component").$$render($$result, Object_1$1.assign(listProps, { hoverItemIndex }), {
...
${validate_component(Titleblock, "Titleblock").$$render($$result, {
    ...
    contents: [
      ...
      { label: "Changes over time" },
      {
        label: "Latest results and insights",
        url: "/"
      }
    ]
  }, {}, {
    default: () => {
      return `${validate_component(Headline, "Headline").$$render($$result, {}, {}, {
        default: () => {
          return `${escape(place.name)}`;
        }
      })}
	<p${add_styles({ "margin": `0 0 10px 0`, "padding": 0 })}><strong>${escape(place.parents[0].name == "Wales" ? "Unitary authority" : capitalise(place.gss.long))}: </strong>${escape(capitalise(place.code))}</p>
...
${validate_component(Article, "Article").$$render($$result, {}, {}, {
    ...
    ${place.stories.length > 6 ? `<button class="${"svelte-9h2wls"}"><div class="${"triangle-container svelte-9h2wls"}"><svg height="${"25"}" width="${"50"}">${`<polygon points="${"25,20 15,10 25,20 35,10"}" class="${"triangle svelte-9h2wls"}"></polygon>`}</svg></div>
      ${escape("Read more")}</button>` : ``}
    <div style="${"height: 50px"}"></div>
